...
user_pref("browser.startup.lastColdStartupCheck", 1765460228);
...
user_pref("extensions.lastAppBuildId", "20251007120000");
user_pref("extensions.lastAppVersion", "128.14.0");
user_pref("extensions.lastPlatformVersion", "128.14.0");
user_pref("extensions.lastTorBrowserVersion", "14.5.8");
...
user_pref("extensions.webextensions.uuids", "{\"{73a6fe31-595d-460b-a920-fcc0f8843232}\":\"cae94df0-3ea8-4ea2-905d-8f9905670585\",\"default-theme@mozilla.org\":\"802b3cc8-382c-4e7e-9228-687e0136eb9d\"}");
user_pref("gecko.handlerService.defaultHandlersVersion", 1);
user_pref("gfx-shader-check.build-version", "20251007120000");
...
user_pref("media.gmp-manager.buildID", "20251007120000");
user_pref("media.gmp-manager.lastCheck", 1761640991);
user_pref("media.gmp-manager.lastEmptyCheck", 1761640991);
...
user_pref("privacy.resistFingerprinting.letterboxing.vcenter", false);
...
user_pref("toolkit.startup.last_success", 1765460225);
